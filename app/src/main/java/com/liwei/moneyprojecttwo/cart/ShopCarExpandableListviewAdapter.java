package com.liwei.moneyprojecttwo.cart;
...
public class ShopCarExpandableListviewAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            cholder.image= (ImageView) convertView.findViewById(R.id.iv_adapter_list_pic);
        ...
        if (productInfo != null) {
            ...
            ImageLoader.getInstance().displayImage(productInfo.getImageUrl(),cholder.image);
            //子条目多选框监听
